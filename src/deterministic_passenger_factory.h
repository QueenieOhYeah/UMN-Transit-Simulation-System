 ...
 */
class DPassengerFactory {
 public:
 /**
  * @brief Generation of a passenger with a deterministic name within bounds.
  *
 ...
 private:
 /**
  * @brief Generation of deterministic passenger name from prefix, stems and suffixes.
  *
