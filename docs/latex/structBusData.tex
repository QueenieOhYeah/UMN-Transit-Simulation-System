\hypertarget{structBusData}{}\doxysection{Bus\+Data Struct Reference}
\label{structBusData}\index{BusData@{BusData}}
...
\begin{center}
\leavevmode
\includegraphics[width=181pt]{structBusData__coll__graph}
\end{center}
\end{figure}
